...
An E-commerce website with following features:

- User authentication
- Create/Close auction listing
- Bid on auction listing
- Comment on auction listing
...
3. Clone project:
        ...
        git clone https://github.com/srky420/cs50w-project2.git
